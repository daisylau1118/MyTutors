...
public class MyHistoryRecyclerAdapter extends RecyclerView.Adapter<MyHistoryRecyclerAdapter.myViewHolder>{

    private List<String> list;

    public MyHistoryRecyclerAdapter(List<String>list){
        this.list = list;
    }
